...
const Homepage = () => {
  ...
  return (
    <div className="h-screen relative bg-gray-200 text-gray-700">
      <WalletAddress account={account} />
      <div className="container mx-auto pt-40 px-3 sm:px-0">
        {isLoading && (
          <div className="w-full max-w-sm mx-auto bg-slate-200 p-8 rounded-xl flex items-center justify-center">
